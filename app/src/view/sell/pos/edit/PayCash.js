Ext.define('Erp.view.sell.pos.edit.PayCash', {
    extend: 'Erp.base.Dialog',
    xtype: 'sell_pos_paycash',
    reference: 'sell_pos_paycash',
    requires: [
        'Erp.util.Nominal'
    ],
    listeners: {
                            ...
                            items: [
                                {
                                    xtype: 'label',
                                    flex: 1,
                                    cls: 'size-16 bolder white',
                                    html: `${i18n.gettext('Need to pay')}:`
                                },
                                {
                                    xtype: 'label',
                                    width: 100,
                                    cls: 'size-24 bolder text-right white',
                                    bind: {
